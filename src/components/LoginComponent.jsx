        ...
        <div className='w-[80%] h-[80%]  mb-16 ml-16'>
            ...
            <div className='flex'>
                <div className='w-8/12 h-full'>
                    <form className="h-[70%] w-[70%] bg-white pl-32 mt-10">
                        <h1 className="my-6 text-xl font-semibold">Login</h1>
                        <div className="w-full">
                            <input type="email" className="w-full p-2 border-2 rounded-md border-gray focus:outline-none" placeholder="Email" />
                        </div>
                        <div className="w-full my-4">
                            <input type="password" className="w-full p-2 border-2 rounded-md border-gray focus:outline-none" placeholder="Password" />
                        </div>
                ...
                <div className='relative z-10 w-4/12 bg-blue-300'>
                    <Image src={"/assets/icons/decor.jpg"} width={500} height={700} />
                </div>
            </div>
        </div>
    </div>
