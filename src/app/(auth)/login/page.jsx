      ...
      <div className="w-[80%] h-[80%]  mb-16 ml-16">
        ...
        <div className="flex">
          <div className="w-8/12 h-full">
            <form
              className="h-[70%] w-[70%] bg-white pl-32 mt-10"
              action={handleLogin}
            >
              ...
              <div className="w-full">
                <input
                  type="email"
                  name="email"
                  className="w-full p-2 border-2 rounded-md border-gray focus:outline-none"
                  placeholder="Email"
                />
              </div>
              ...
              <div className="w-full my-6">
                <button className="w-full p-2 text-white rounded-md bg-gray">
                  Login
                </button>
              </div>
              <div className="w-full">
